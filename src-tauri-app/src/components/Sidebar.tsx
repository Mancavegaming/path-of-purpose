...
export type Page = "build" | "delta" | "generator" | "editor" | "character" | "streaming" | "filter" | "pricecheck" | "stash" | "atlas";
  ...
  return (
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <button
          class={`nav-item ${props.page() === "filter" ? "active" : ""}`}
          onClick={() => props.setPage("filter")}
        >
          <span class="nav-icon">{"\u{1F3AF}"}</span>
          Loot Filter
        </button>
        <button
          class={`nav-item ${props.page() === "pricecheck" ? "active" : ""}`}
          onClick={() => props.setPage("pricecheck")}
        >
        ...
        <button
          class={`nav-item ${props.page() === "atlas" ? "active" : ""}`}
          onClick={() => props.setPage("atlas")}
        >
          <span class="nav-icon">{"\u{1F5FA}"}</span>
          Atlas Tree
        </button>
        <button
